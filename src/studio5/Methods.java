...
public class Methods {
	...
	public static String substituteAll(String source, char target, String replacement) {
		...
		for (int i = 0; i<source.length(); i++) {
			if (source.charAt(i)==target){
				result=source.substring(0, i)+replacement+source.substring(i+1);
			}
		}
	...
	// TODO: Create an arrayMean method which accepts an integer array of values parameter.
	...
	/**
	 * Return an mean of an input of integer array.
	 * 
	 * @param values the array of values
	 * @return mean value of @param values;
	 */
